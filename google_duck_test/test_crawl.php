...
$urls_to_crawl = array("http://www.cnn.com", "http://www.wsj.com", "https://pixabay.com");
//$startUrl = "http://www.bbc.com";

for ($x = 0; $x < count($urls_to_crawl); $x++) {
    // echo "Next URL : $urls_to_crawl[$x]";
    followLinks($urls_to_crawl[$x]);
}
